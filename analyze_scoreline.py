...
for game in data:
    ...
    if sPLoserWins == 12:
        ...
        #print("forced" if scorelines == forced_scorelines else "not_forced")
...
# FORCING
fig, (forced_ax, not_forced_ax) = plt.subplots(1, 2, figsize=(18, 8))
forced_ax.set_title("VCT 2023-Present Data: Chance of Winning a Map After You Lose 2nd Pistol and Force")
not_forced_ax.set_title("VCT 2023-Present Data: Chance of Winning a Map After You Lose 2nd Pistol and Don't Force")

for scorelines, ax in ((forced_scorelines, forced_ax), (not_forced_scorelines, not_forced_ax)):
